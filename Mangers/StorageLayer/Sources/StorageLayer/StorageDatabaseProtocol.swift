...
public typealias StorageCompletionHandler = ((Result<Bool , Error>) -> Void)?
...
public protocol StorageDatabase: StorageDatabaseSaver,
                                 StorageDatabaseFetcher,
                                 StorageDatabaseDelete {}

// MARK: - StorageDatabaseSaver

public protocol StorageDatabaseSaver {
...
// MARK: - StorageDatabaseFetcher

public protocol StorageDatabaseFetcher {
...
// MARK: - StorageDatabaseDelete

public protocol StorageDatabaseDelete {
